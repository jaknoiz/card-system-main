...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="text-danger fw-bold">แก้ไขข้อมูลเจ้าหน้าที่</h2>
    </div>
    ...
    <form action="{{ route('contacts.update', $contact->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body text-center">
                <input type="file" name="profile_image" class="form-control mb-3" id="profile_image" onchange="previewImage(event)">
        ...
        <div class="d-flex justify-content-center mb-4">
            <a href="{{ route('contacts.index') }}" class="btn btn-danger mx-2">ย้อนกลับ</a>
            <button type="submit" class="btn btn-primary mx-2">บันทึกการเปลี่ยนแปลง</button>
        </div>
    </form>
</div>
